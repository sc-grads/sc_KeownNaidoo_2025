...
namespace LinqSQL
{
	...
	[global::System.Data.Linq.Mapping.DatabaseAttribute(Name="VsDB")]
    ...
    partial void DeleteStudentLecture(StudentLecture instance);
		...
		public LinqToSqlDataClassesDataContext() : 
				base(global::LinqSQL.Properties.Settings.Default.VsDBConnectionString, mappingSource)
		{
			OnCreated();
		}
    ...
    partial void OnNaneChanging(string value);
    partial void OnNaneChanged();
    #endregion
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_Nane", DbType="NVarChar(50) NOT NULL", CanBeNull=false)]
		public string Nane
		{
			get
			{
			...
			set
			{
				if ((this._Nane != value))
				{
					this.OnNaneChanging(value);
					this.SendPropertyChanging();
					this._Nane = value;
					this.SendPropertyChanged("Nane");
					this.OnNaneChanged();
				}
			}
		}
    ...
    partial void OnLectureIdChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Lecture_StudentLecture", Storage="_Lecture", ThisKey="LectureId", OtherKey="Id", IsForeignKey=true)]
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Student_StudentLecture", Storage="_Student", ThisKey="StudentId", OtherKey="Id", IsForeignKey=true)]
